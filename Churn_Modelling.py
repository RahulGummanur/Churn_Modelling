...
print(ann.add(tf.keras.layers.Dense(units = 6,activation = 'relu')))
...
# # Making the predictions and Evaluating the predictions.
...
# Therfore the probability that the customer leavs the bank is low.
